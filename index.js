...
const ownerNumber = ['252613982172']
...
console.log("CONNECTING SOMBOT-MD 🧬...");
...
console.log('SOMBOT-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ SOMBOT-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ LP ✅*
...
//================ownerreact==============
if(senderNumber.includes("252613982172")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("252613982172")){
